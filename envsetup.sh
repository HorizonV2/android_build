...
function genkey() {
    local subject="/C=US/ST=California/L=Los Angeles/O=HorizonDroid/OU=HorizonDroid/CN=HorizonDroid"
    ...
    echo "$bazel_build_content" > vendor/horizon-priv/keys/BUILD.bazel
}
...
export ANDROID_KEY_PATH="$ANDROID_BUILD_TOP/vendor/horizon-priv/keys"
